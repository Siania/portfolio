...
const THEME_KEY = 'oksana-theme';

const LightIcon = () => (
  <svg className="theme-switcher__icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 36 36">
...
const options = [
  { value: 'light', label: 'Light', cOption: '1', Icon: LightIcon },
  { value: 'dark', label: 'Dark', cOption: '2', Icon: DarkIcon },
